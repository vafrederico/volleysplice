...
bash ./sign-release.sh app/build/outputs/apk/release/app-release-unsigned.apk \
  --output app/build/outputs/apk/release/VolleySplice-v0.10.13-arm64-release-signed.apk
bash ./sign-release.sh app/build/outputs/bundle/release/app-release.aab \
  --output app/build/outputs/bundle/release/VolleySplice-v0.10.13-arm64-release-signed.aab
```
