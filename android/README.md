...
bash ./sign-release.sh app/build/outputs/apk/release/app-release-unsigned.apk \
  --output app/build/outputs/apk/release/VolleyCut-v0.10.5-arm64-release-signed.apk
bash ./sign-release.sh app/build/outputs/bundle/release/app-release.aab \
  --output app/build/outputs/bundle/release/VolleyCut-v0.10.5-arm64-release-signed.aab
```
