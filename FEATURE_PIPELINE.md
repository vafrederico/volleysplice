...
- **Production browser**: deployed and persisted by the production web client, with an
  Android parity port still required.
...
candidate anchors in the recording. The following table records the browser source and
the work Android must reproduce:
