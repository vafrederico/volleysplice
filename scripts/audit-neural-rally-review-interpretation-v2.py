...
def main():
    ...
    require('93.84% export F1' in executive and '93.66% export F1' in executive,
            'Corrected executive rounding absent')
    require('93.83% export F1' not in executive and '93.65% export F1' not in executive,
            'Superseded executive rounding remains')
    ...
    receipt = {'passed': True, 'kind': 'independent-rally-review-interpretation-audit-v2',
    ...
    destination = ROOT/'interpretation-audit-v2.json'
