...
def audit(plan_path, inventory_path, output):
    ...
    require(plan['code']['scripts/audit-neural-selection-identity-cache-v2.py'] == evidence.capture(__file__),
    ...
    require(inventory['kind'] == 'selection-identity-cache-run-inventory-v1' and inventory['plan'] == plan_ref
            and inventory['source'] == plan['code']['scripts/generalization-selection-cache-execution-v2.py'],
