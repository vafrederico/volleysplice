...
const APK_FILENAME = "VolleyCut-v0.10.11-arm64-release-signed.apk";
  ...
  return (
    <aside className={styles.banner} aria-label="Android app download">
      ...
      <a
        ...
        aria-label="Download VolleyCut v0.10.11 signed ARM64 APK"
      >
        <span>Download APK</span>
        <small>v0.10.11 · ARM64 · SIGNED</small>
      </a>
    </aside>
  );
}
